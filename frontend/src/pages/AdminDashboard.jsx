...
import { AuthContext, NotificationContext, DarkModeContext } from "../App";
import {
...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-[#0A2A43] transition-colors duration-500">
            {/* Sidebar */}
